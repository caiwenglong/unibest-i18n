...
const presetApplet = definePreset(
  (options = {}) => {
    ...
    const presetWind3$1 = presetWind3({ ...options, preflight: false });
    presetWind3$1.rules?.pop();
    presetWind3$1.variants?.splice(1, 1, ...variantSpaceAndDivide(options), ...variantWildcard(options));
    return {
      ...presetWind3$1,

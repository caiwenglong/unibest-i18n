...
var _vitePluginUniManifest = await jitiImport("@uni-helper/vite-plugin-uni-manifest");
var _vite = await jitiImport("vite");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };} // manifest.config.ts
...
// 获取环境变量的范例
const env = (0, _vite.loadEnv)(getMode(), _nodePath.default.resolve(_nodeProcess.default.cwd(), 'env'));
const {
  VITE_APP_TITLE,
  VITE_UNI_APPID,
  VITE_WX_APPID,
...
(0, _vitePluginUniManifest.defineManifestConfig)({
  'name': VITE_APP_TITLE,

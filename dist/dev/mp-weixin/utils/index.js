...
function getAllPages(key = "excludeLoginPath") {
...
function getCurrentPageI18nKey() {
  const routeObj = currRoute();
  const currPage = pages_json.pages.find((page) => `/${page.path}` === routeObj.path);
  if (!currPage) {
    console.warn("路由不正确");
    return "";
  }
...
function isCurrentPageTabbar() {
  ...
  return tabbar_store.isPageTabbar(path);
}
...
exports.getCurrentPageI18nKey = getCurrentPageI18nKey;
exports.getEnvBaseUrl = getEnvBaseUrl;
exports.getLastPage = getLastPage;
exports.isCurrentPageTabbar = isCurrentPageTabbar;
